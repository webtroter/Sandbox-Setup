...
$vscodeHeader = New-BTHeader -Id 3 -Title "VSCode Setup"
New-BurntToastNotification -Text "Starting VSCode Install" -Header $vscodeHeader
...
New-BurntToastNotification -Text "Finished VSCode Install" -Header $vscodeHeader